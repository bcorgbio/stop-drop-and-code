...
<div class="comment">
Bummer! You didn't include the data! I put the directory in your repo so this, and everything else, will run. The tree file, image metadata and taxon names, too!
...
We need a narrative for the results.
...
The Lepidoptera have been widely studied and are renowned for their importance in forests, treeless regions, wetlands, and various other terrestrial ecosystems. Lepidoptera contain a body segmented into 3 parts, head, thorax, and abdomen, along with a forewing and hindwing. Studies have been conducted that demonstrate hindwing and forewing have evolved independently (@owens_lewis_condamine_kawahara_guralnick_2020). In terms of the data that our group collected, wing shape has been shown to be conserved across groups. When analyzing our species, our group was able to deduce that low variation among the groups in regards to PC2 would also point to low phenotypic rate variation. Evolutionary rate shift analysis indicated that the Noctuoidea family of the Marchetoercoera clade, exhibited the largest significant change: -0.001940948 units. Through the use of the p- and R-squared values exhibited in the PC1 analysis, our group was able to deduce a relationship between the hindwing and forewing. This correlation though does not apply to the PC2 analysis as the p-value of 0.4121 and R-squared value of -.001955 are far too low. Previous studies analyzing hindwing and forewing have pointed out that there are multiple limiting factors, including each group's ecological niche, methodological limitations (@owens_lewis_condamine_kawahara_guralnick_2020), and more. Because of these factors, previous researchers have found it difficult to determine the reasoning behind this variation, or lack thereof, amongst and between Lepidoptera species.
...
<div class="comment">
Excellent work. Thanks for staying the course and producing a very fine analysis more reflective of graduate work. Please just remember to include all your data and some narrative to the results. Congrats to you all! 
