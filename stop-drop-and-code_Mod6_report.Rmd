...
<br>
The phylogenetic tree used in the analysis of this report was created by @kawahara2019. To compare the rates of evolution throughout major Lepidoptera lineages, the non-censored test  by O'Meara et. Al (2006) was used within the R package phytools. After eliminating species from the original phylogenetic tree that were not included in this report, evolutionary rates were calculated for the first and second PCs in fore- and hind-wings
<br>
